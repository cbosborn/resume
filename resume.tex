...
\section{Work}
	...
	\item Engineered back end services: financial integration via \href{http://www.plaid.com}{Plaid}, REST API for client app \& interaction with numerous 3$^{\rm rd}$ party services. Written in JavaScript/Nodejs, \& deployed to cloud with AWS EC2, AWS Lambda, Heroku, etc.
